...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        for coin in range(COIN_COUNT):
            ...
            coin.textures.append(arcade.load_texture("images/gold_1.png", scale=0.5))
            coin.textures.append(arcade.load_texture("images/gold_1.png", scale=0.35))
            coin.textures.append(arcade.load_texture("images/gold_1.png", scale=0.25))
            coin.textures.append(arcade.load_texture("images/gold_1.png", scale=0.35))
            coin.textures.append(arcade.load_texture("images/gold_1.png", scale=0.5))
